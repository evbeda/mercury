...
class OrderTable(tables.Table):
    ...
    def render_actions(self, value, record):
        return format_html('<div class="row text-center"><div class="col-12 text-center"><a id="hip_not_underline" href="/view_order/{}/"><i class="material-icons md-18">search</i></a></div></div>'.format(record.id))
